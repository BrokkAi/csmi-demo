...
The runner verifies the shared scenario, runs the adapter unit tests, installs
the committed dependency lock into an isolated cache with global CodeQL pack
configuration disabled, and verifies exact `codeql/java-all` `9.2.3` (build SHA
